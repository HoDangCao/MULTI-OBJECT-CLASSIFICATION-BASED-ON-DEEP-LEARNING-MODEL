...
See the `README.md` file in the `data` directory for instructions on downloading and setting up the datasets if you want to use the COCO dataset. Otherwise, read and run the food-data-exploration.ipynb to get the food-challenge dataset.

The transform.ipynb contains model improvements and analysis.

Run cells in single-positive-multi-label\zbuild_new_image_size.ipynb to see the analysis and the crop the picture dataset.
