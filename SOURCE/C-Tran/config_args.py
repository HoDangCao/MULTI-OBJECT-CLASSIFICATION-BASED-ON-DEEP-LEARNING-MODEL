...
def get_args(parser,eval=False):
    ...
    parser.add_argument('--dataset', type=str, choices=['food', 'food_80_20', 'coco', 'voc','coco1000','nus','vg','news','cub'], default='coco')
    parser.add_argument('--workers', type=int, default=0) #default = 10
    ...
    # Model extend name
    parser.add_argument('--extendName', type=str, default='standard')
    """
    This will help you can distinguish many files of result. 
    """
    
    # Segmentation model
    parser.add_argument('--use_seg', dest='use_seg', action='store_true',help='segmentation model UNet') 
