...
# Modified before 26/3/2024
# train_loader, valid_loader, test_loader, train_obs, val_obs = get_data(args) 

# Modified after 26/3/2024
train_loader, valid_loader, test_loader, train_obs, val_obs, test_obs = get_data(args) 
...
if args.dataset == 'cub':
    ...
    # model = CTranModel(train_obs, val_obs, args.num_labels,args.use_lmt,args.pos_emb,args.layers,args.heads,args.dropout,args.no_x_features)
    
    # Modified after 26/3/2024. Content: train 80, valid 20. 
    model = CTranModel(train_obs, val_obs, test_obs, args.num_labels,args.use_lmt,args.pos_emb,args.layers,args.heads,args.dropout,args.no_x_features)
    print(model.self_attn_layers)
